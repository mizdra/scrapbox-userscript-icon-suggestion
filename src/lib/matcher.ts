 ...
 */
export function fuzzyMatcher<T>(query: string, icons: Icon<T>[]): Icon<T>[] {
 ...
 * */
export function forwardMatcher<T>(query: string, icons: Icon<T>[]): Icon<T>[] {
 ...
 * */
export function partialMatcher<T>(query: string, icons: Icon<T>[]): Icon<T>[] {
 ...
 * */
export function forwardPartialFuzzyMatcher<T>(query: string, icons: Icon<T>[]): Icon<T>[] {
